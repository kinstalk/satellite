...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		fill: function () {
			...
			this.picker.find('tfoot th.today')
				.text(dates[this.language].today[0])
				.toggle(this.todayBtn !== false);
			this.picker.find('tfoot th.today_zero')
				.text(dates[this.language].today[1])
				.toggle(this.todayBtn !== false);
					...
					case 'th':
						switch (target[0].className) {
							...
							case 'today_zero': // 新增当天零点按钮
								...
								break;
							case 'close_date': // 新增关闭按钮
								this.hide();
								break;
							case 'clean_date': // 新增清除按钮
								this.reset();
								this.hide();
								break;
						}
	...
	var DPGlobal = {
		...
		footTemplate:     '<tfoot><tr><th colspan="2" class="today"></th><th colspan="3" class="today_zero"></th><th class="clean_date" title="清除" ><li class="glyphicon glyphicon-trash" ></li></th><th class="close_date" title="关闭"><li class="glyphicon glyphicon-remove"><li></th></tr></tfoot>'//增加零点操作
	};
