...
$(function () {
    ...
    function n() {
        ...
        if ($(".J_menuTab").each(function () {
                return $(this).data("id") == t ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"),$("#iframe"+a).attr('src', $("#iframe"+a).attr('src')) , e(this), $(".J_mainContent .J_iframe").each(function () {
            ...
            var r = '<iframe class="J_iframe" id="iframe'+a+'" name="iframe' + a + '" width="100%" height="100%" src="' + t + '?v=4.0" frameborder="0" data-id="' + t + '" seamless></iframe>';
    ...
    function d() {
        if (!$(this).hasClass("active")) {
            ...
            $(".J_mainContent .J_iframe").each(function () {
                return $(this).data("id") == t ? ($(this).show().siblings(".J_iframe").hide(), $(this).attr('src', $(this).attr('src')),!1) : void 0
